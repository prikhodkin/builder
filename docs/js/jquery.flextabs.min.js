...
!function (t, e) {
  ...
  n.defaults = {
    ...
    if (!0 !== c.inited) {
      if (c[d] = {}, c.animation = "auto", c.nsid = __.getRndNum(1e4, 9e4), c.ns = "ft-" + c.nsid, c.id = l.attr("id") || c.ns, l.attr("id", c.id), n.instances[c.id] = c, c.origin = {
        attrs: {
          "class": ""
        },
        html: l.html()
        ...
        if (u.test(h)) {
          ...
          for (var v = p.length - 1; v >= 0; v--) {
            Number(p[v]) && (p[v] = Number(p[v])), c.open(p[v], !1, 0);
          }
        }
      }
    ...
    function e(e) {
      t.each(v.navElems[e], function (m, g) {
        var b,
            ...
            T = {};
        g[u](l.tab).attr(f, m), (w = g.attr("href")) ? (b = w.replace("#", ""), y = "href", g.attr("href", "#" + n.id + "=" + b)) : (M = g.attr(h)) ? (b = M, y = h) : (b = "ft-" + __.getRndNum(1e4, 9e4), y = h, g.attr(h, b)), E.length || (E = t(p).appendTo(v.cnt)), E.attr("id", b)[u](l[r]).attr(f, m).hide(), x = g.clone(!0, !0), e == i ? E.before(x) : e == s && v.nav.append(x), T = {
          id: b,
          attrID: y,
          index: m,
          control: {
    ...
    switch (v.it = t(n.it)[u](l.container + " " + a.theme), a.type) {
      ...
      case s:
        v.cnt = v.it.wrapInner(t(p, {
          "class": l.contents
        })).children().eq(0), v.cntElems = v.cnt.children().filter(":odd"), v.nav = t("<nav/>", {
          "class": l.nav
    ...
    } else if (o == s) if (a.collapsible) c.status ? n.close(c, !1, e) : n.open(c, !1, e);else if (!a.collapsible) {
      if (c.status) return;
    ...
    if (e) if (a.call(o), n || (o.sets.type = e, e != i)) {
    ...
    var n = this,
        a = n.it,
        i = "object" == _typeof(e) && 0 != Object.keys(e).length ? e : t.extend(!0, {}, n.sets, {
      type: n.origin.type
    });
    n.destroy(), t(a)[l](i);
  }, __ = {
    getRndNum: function getRndNum(t, e) {
    ...
    return t.each(this, function (t, c) {
      "object" == _typeof(s) || void 0 === s ? c[l] = a(c, s) : "init" == s || "reinit" == s ? c[l] ? e(c, s, i) : c[l] = a(c, i[1]) : e(c, s, i), n.hasHash && t == o - 1 && history.pushState({
        a: "a"
